...
//                || GeneralPreferenceFragment.class.getName().equals(fragmentName)
    ...
    public static class WeatherPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("pref_temperature_measure"));
            bindPreferenceSummaryToValue(findPreference("pref_wind_speed_measure"));
...
//                    Toast.makeText(getContext(), "Clicked: " + preference.getKey(), Toast.LENGTH_SHORT).show();
        ...
        private AlertDialog createAboutDialog(Context c){
